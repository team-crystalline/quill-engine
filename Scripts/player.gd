...
@export var current_speed : int = 0 # come back to this.
@export var acceleration_rate : float = 0
@export var deceleration_rate : float = 0
@export var top_speed : int = 400 # Fastest speed he can run without help + momentum
@export var max_speed : int = 500 # Fastest speed he can run with help + momentum
...
@export var air_acceleration_rate : int = 0
@export var air_deceleration_rate : int = 0
@export var air_top_speed : int = 300
